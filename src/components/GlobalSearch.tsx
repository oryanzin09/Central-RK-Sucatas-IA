          ...
          {isOpen && (
            <div className="fixed inset-0 pointer-events-none z-[10000]">
              ...
              <motion.div
                ...
                className={cn(
                  "absolute z-10 rounded-2xl shadow-2xl overflow-hidden border flex flex-col pointer-events-auto",
                  isMobile 
                    ? "bottom-[15px] left-4 right-4 max-h-[85vh]" 
                    : "bottom-[15px] left-1/2 -translate-x-1/2 w-[95%] max-w-2xl max-h-[70vh]",
              ...
              >
                ...
                <div className={cn(
                  ...
                  theme === 'dark' ? "border-zinc-800 bg-zinc-900/50" : "border-indigo-600/10 bg-gray-50/50"
                )}>
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className={cn("font-bold text-sm", theme === 'dark' ? "text-white" : "text-zinc-900")}>
                      Busca Global
                    </h3>
                  </div>
                  <button
                    ...
                    className={cn(
                      ...
                      theme === 'dark' ? "hover:bg-zinc-800 text-zinc-400" : "hover:bg-gray-200 text-zinc-500"
                    )}
                  >
                    <X size={18} />
                  </button>
